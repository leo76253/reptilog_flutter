...
import 'package:reptilog_flutter/pages/home/home.dart';
import 'package:reptilog_flutter/pages/reptiles/detials.dart';
import 'package:reptilog_flutter/pages/reptiles/edit.dart';
...
final GoRouter _router = GoRouter(
  routes: [
    ...
    GoRoute(
      path: '/reptiles/edit/:id',
      builder: (context, state) {
        final String? reptileId = state.pathParameters['id'];
        return ReptileEditPage(reptileId: reptileId ?? '0');
      },
    ),
  ],
);
